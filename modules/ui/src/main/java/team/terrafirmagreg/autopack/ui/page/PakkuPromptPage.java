...
public class PakkuPromptPage extends JPanel {
    ...
    public PakkuPromptPage(String titleKey, String messageKey, List<String> entries) {
        $$$setupUI$$$();
        ...
        yesButton.setToolTipText(Messages.get("autopack.pakku.yes.tooltip"));
        noButton.setText(Messages.get("autopack.pakku.no"));
        noButton.setToolTipText(Messages.get("autopack.pakku.no.tooltip"));
        cancelAndExitButton.setText(Messages.get("autopack.pakku.cancel"));
        cancelAndExitButton.setToolTipText(Messages.get("autopack.pakku.cancel.tooltip"));
