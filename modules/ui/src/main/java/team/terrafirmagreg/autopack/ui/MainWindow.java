...
import team.terrafirmagreg.autopack.ui.page.ConsentPage;
...
public class MainWindow extends JFrame {
    ...
    public MainWindow(LoggerDelegate logger) {
        this.logger = logger;
        add(root);
    ...
    private void $$$setupUI$$$() {
        ...
        modpackName.setText("AutoPack Director");
        panel1.add(
                modpackName,
                new GridConstraints(
                        0,
    ...
    public void setModpackIcon(Image icon, Dimension dimension) {
        if (icon == null) {
            ...
            setIconImage(icon);
            modpackIcon.setIcon(
                    new ImageIcon(icon.getScaledInstance(dimension.width, dimension.height, Image.SCALE_SMOOTH)));
        }
    }
}
