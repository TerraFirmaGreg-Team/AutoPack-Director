...
public class ConsentPage extends JPanel {
    ...
    public ConsentPage(List<InstallableMod> toInstall) {
        $$$setupUI$$$();
        ...
        nextButton.setToolTipText(Messages.get("autopack.ui.consent.accept.tooltip"));
        ...
        cancelAndExitButton.setToolTipText(Messages.get("autopack.ui.consent.cancel.tooltip"));
    ...
    private void createEntry(InstallableMod mod) {
        ...
        var sourceName =
                Messages.get("autopack.ui.consent.source", mod.remoteMod().remoteType());

        modPane.setBorder(BorderFactory.createTitledBorder(
