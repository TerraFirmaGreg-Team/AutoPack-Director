package team.terrafirmagreg.autopack.ui.components;
...
public class ScrollablePane extends JPanel implements Scrollable {
    ...
    public ScrollablePane(
            LayoutManager layout, boolean scrollableTracksViewportWidth, boolean scrollableTracksViewportHeight) {
        this(layout);
        this.scrollableTracksViewportWidth = scrollableTracksViewportWidth;
        this.scrollableTracksViewportHeight = scrollableTracksViewportHeight;
    }
    ...
    public ScrollablePane(
            boolean isDoubleBuffered, boolean scrollableTracksViewportWidth, boolean scrollableTracksViewportHeight) {
