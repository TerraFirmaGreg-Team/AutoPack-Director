...
public class ForgeLateLoader {
    ...
    private final Tweaker directorTweaker;
    ...
    public ForgeLateLoader(Tweaker directorTweaker, Director director, LaunchClassLoader classLoader) {
    ...
    public void execute() {
        ...
        if (!deobfFound) {
            ...
            tweakClasses.add(0, "team.terrafirmagreg.autopack.launchwrapper.forge.AfterDeobfTweaker");
        }
    }
