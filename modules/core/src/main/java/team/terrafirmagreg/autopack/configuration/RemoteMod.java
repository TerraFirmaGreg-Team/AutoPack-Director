...
public abstract class RemoteMod {
    ...
    protected RemoteMod(RemoteModBuilder<?, ?> builder) {
        ...
        this.installationPolicy = builder.installationPolicy == null
                ? InstallationPolicy.builder().build()
                : builder.installationPolicy;
    ...
    protected RemoteMod(
        ...
        this.installationPolicy =
                installationPolicy == null ? InstallationPolicy.builder().build() : installationPolicy;
    ...
    public abstract void performInstall(
