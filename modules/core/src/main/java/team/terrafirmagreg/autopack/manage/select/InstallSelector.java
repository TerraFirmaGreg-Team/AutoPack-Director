...
public class InstallSelector {
    ...
    public void accept(
            List<RemoteMod> excludedMods, List<InstallableMod> freshInstalls, List<InstallableMod> reInstall) {
                        ...
                        if (optionalKey == null) {
                            ...
                            SelectableInstallOption installOption = new SelectableInstallOption(
                                    ...
                                    policy.name() == null
                                            ...
                                            : policy.name() + " - " + remoteMod.offlineName(),
                                    policy.description());
                            if (optionalKey.equals("$")) {
                                singleOptions.add(installOption);
                            } else {
                                groupOptions
                                        .computeIfAbsent(optionalKey, k -> new ArrayList<>())
                                        .add(installOption);
                            }
