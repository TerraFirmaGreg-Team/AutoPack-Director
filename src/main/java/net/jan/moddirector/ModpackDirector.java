...
import net.jan.moddirector.ui.DirectorMainGUI;
...
public class ModpackDirector implements Callable<Boolean> {
    ...
    public Boolean call() throws Exception {
        ...
        var preInstallationPage = ui == null ? null
            : ui.progressPage("mod_director.progress.check_install");
        ...
        var installProgressPage = ui == null ? null :
            ui.progressPage("mod_director.progress.install", modpackConfiguration.packName());
        ...
        if (modpackConfiguration.remoteVersion() != null && modpackConfiguration.localVersion() != null && !modpackRemoteVersion.contains(modpackConfiguration.localVersion())) {
            ...
            if (ui != null) {
                var baseKey = modpackConfiguration.refuseLaunch() ? "mod_director.modpack_outdated_refuse_launch" : "mod_director.modpack_outdated";
        ...
        if (modpackConfiguration.requiresRestart() && !freshInstalls.isEmpty()) {
            ...
            if (ui != null) {
                ui.messagePage("mod_director.restart_required.title", "mod_director.restart_required",
                    "mod_director.restart_required.button").waitForButton();
            }
            UnsafeExit.exit(0);
        }
